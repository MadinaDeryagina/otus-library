...
import otus.deryagina.spring.library.data.metrics.dao.BookRepository;
...
import otus.deryagina.spring.library.data.metrics.mapper.ModelMapperImpl;
import otus.deryagina.spring.library.data.metrics.services.BookService;
import otus.deryagina.spring.library.data.metrics.services.BookServiceImpl;
...
@ComponentScan("otus.deryagina.spring.library.data.rest.dao")
