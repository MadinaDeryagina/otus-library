package otus.deryagina.spring.library.data.mvc.shell;

import lombok.AllArgsConstructor;
import org.springframework.shell.standard.ShellComponent;
import org.springframework.shell.standard.ShellMethod;
import otus.deryagina.spring.library.data.mvc.interaction.InteractionService;
import otus.deryagina.spring.library.data.mvc.services.AuthorService;
import otus.deryagina.spring.library.data.mvc.services.BookService;
import otus.deryagina.spring.library.data.mvc.services.GenreService;


@ShellComponent
@AllArgsConstructor
public class LibraryMvcApplicationCommands {
