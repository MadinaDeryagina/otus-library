package otus.deryagina.spring.library.data.nosql.shell;

import lombok.AllArgsConstructor;
import org.springframework.shell.standard.ShellComponent;
import org.springframework.shell.standard.ShellMethod;
import otus.deryagina.spring.library.data.nosql.interaction.InteractionService;
import otus.deryagina.spring.library.data.nosql.services.AuthorService;
import otus.deryagina.spring.library.data.nosql.services.BookService;
import otus.deryagina.spring.library.data.nosql.services.GenreService;


@ShellComponent
@AllArgsConstructor
public class LibraryDataNoSqlApplicationCommands {
